<template>
    <div id="license">
        <div class="com_contain">
            ...
            <h1 class="main_title">이용약관</h1>  

<h2>제1조(목적)</h2>

본 이용약관은 ‘카본플로우’(이하‘사이트’)의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
...
② 회원은 사이트의 명시적 동의가 없는 한 서비스의 이용 권한, 기타 이용계약상 지위를 타인에게 양도,증여할수 없으며, 이를 담보로 제공할 수 없습니다.
③ 이용고객은 아이디 및 비밀번호 관리에 상당한 주의를 기울여야 하며, 운영자나 사이트이 동의 없이 제3자에게 아이디를 제공하여 이용하게 할 수 없습니다.
...
① 서비스 이용 시간은 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간을 원칙으로 합니다. 단, 사이트는 시스템 정기점검, 증설 및 교체를 위해 사이트가 정한 날이나 시간에 서비스를 일시 중단할수 있으며 예정된 작업으로 인한 서비스 일시 중단은 사이트의 홈페이지에 사전에 공지하오니 수시로 참고하시길 바랍니다.
                    ...
                    .text{
                        ...
                        >span{
                            ...
                            >button{
                                width: 8px;
                                height: 8px;
                            background:url("~/assets/img/icon/arrow_drop_down_c.png") no-repeat center center; 
                            }
                        }
                    }
                }
